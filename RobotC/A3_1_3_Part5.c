...
int threshold = 825;
task main() {
	setServo(motorServo, 127);					// move the servo to position 127
	untilDark(threshold, lineFollower); // until a dark object is detected
	setServo(motorServo, -127);         // move to position -127
}
